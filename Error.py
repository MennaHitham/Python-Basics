...
def divide(x, y):
    try:
        result = x / y
    except ZeroDivisionError:#executes when y is 0
        print("division by zero!")
    except TypeError:#executes when x or y not int
        print("Must be int!")
    else:#when no errors happen
        print("result is", result)
    finally: #it executes all the time
